        ...
        try:
            ...
            if user.status == "kicked":
               await client.send_message(
                   ...
                   text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/CT_Arena).",
                   parse_mode="markdown",
	        ...
	        reply_markup=InlineKeyboardMarkup(
                    [
                        [
                           InlineKeyboardButton("Join Updates Channel", url="https://t.me/CT_Arena"),
                           InlineKeyboardButton("Support Group", url="https://t.me/Cinemathattakam_Group")
                      ],
                     [
                           InlineKeyboardButton("🧑‍💻Devloper🧑‍💻", url="https://t.me/Sathan_Of_Telegram")
                     ]
                 ]
             ),
        parse_mode="markdown",
...
async def _source_code(client, message):
	...
	reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Souce Code", url="https://github.com/sathanxavier1998/ForceSub_Bot")
                ],
                [
                    InlineKeyboardButton("Join Updates Channel", url="https://t.me/CT_Arena"),
                    InlineKeyboardButton("Support Group", url="https://t.me/Cinemathattakam_Group")
...
async def _help(client, message):
    ...
    if update_channel:
        try:
            ...
            await client.send_message(
                chat_id=message.chat.id,
                text="Hey use this command in my pm. \nFor more help ask in my [pm](https://t.me/sathan_Of_Telegram).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
